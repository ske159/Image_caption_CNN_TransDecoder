...
from FPN2LSTM import FFtoRNN
from val_loader_test import val_coco

train_img_folder = 'D:/MScocoCaption数据集/train2014'
...
def train():
    ...
    train_loader, train_dataset = get_loader(root_folder=train_img_folder,
    ...
    model = FFtoRNN(embed_size, hidden_size, vocab_size, num_layers).to(device)
